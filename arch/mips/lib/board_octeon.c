...
const char version_string[] =
    U_BOOT_VERSION " (UBNT Build Version: " U_BOOT_VERSION_SHORT ") (" U_BOOT_DATE " - " U_BOOT_TIME ")";
...
# endif
	...
	{
	char tmp[20];
	u64 load_md5_addr = CONFIG_SYS_MD5_LOAD_ADDR;
	snprintf(tmp, sizeof(tmp), "0x%lx", load_md5_addr);
	setenv("md5addr", tmp);
	setenv("check_md5sum", "yes");
	}
#endif
