...
MODEL_STR := $(shell cat model.txt)
VERNUM := $(shell cat version.txt)
...
$(VERSION_FILE):
		...
		@( localvers='$(shell $(TOPDIR)/tools/setlocalversion $(TOPDIR))' ; \
			localvers_short='$(shell $(TOPDIR)/tools/setlocalversion_short $(TOPDIR))' ; \
		   printf '#define U_BOOT_VERSION_SHORT "%s_%s%s"\n' \
			"$(MODEL_STR)" "$(VERNUM)" "$${localvers_short}"; \
